...
public class Puzzle9 {
	...
	public static class IntComputer {
		...
		IntComputer(long[] program) {
			this.program = program;
		}

		IntComputer(long[] program, long phaseSetting) {
			this.program = program;
